                ...
                <div class="bg-white p-6 rounded-lg shadow md:col-span-2 overflow-x-auto">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                                        ...
                                        @elseif($statusOtomatis == 'selesai')
                                            <div class="flex items-center gap-1.5">
                                                ...
                                                <form action="{{ route('transaksi.updateStatus', [$item->id, 'diambil']) }}" method="POST" class="inline">
                                                    @csrf
                                                    <button type="submit" onclick="return confirm('Konfirmasi bahwa cucian ini sudah diambil pelanggan?')" class="p-1 bg-slate-100 hover:bg-slate-200 text-slate-700 rounded-lg text-[10px] font-bold transition">
                                                        Serahkan
                                                    </button>
                                                </form>
                                            </div>
                            ...
                            @empty
                                <tr>
                                    <td colspan="5" class="px-4 py-4 text-center text-sm text-gray-500">Belum ada transaksi hari ini.</td>
                                </tr>
                            @endforelse
                        </tbody>
                    </table>
