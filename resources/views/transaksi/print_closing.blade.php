...
<div class="no-print mb-6 flex items-center gap-2.5 bg-white/80 backdrop-blur-md p-1.5 rounded-2xl border border-slate-200/80 shadow-sm transition-all duration-200 hover:shadow-md">
    ...
    <button type="button" onclick="cetakNota()" class="bg-slate-900 hover:bg-slate-800 text-white text-xs font-semibold py-2 px-4 rounded-xl shadow-sm hover:shadow transition-all duration-200 flex items-center gap-1.5 font-sans active:scale-95">
